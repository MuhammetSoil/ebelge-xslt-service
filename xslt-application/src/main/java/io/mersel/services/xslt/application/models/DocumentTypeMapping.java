...
public final class DocumentTypeMapping {
    ...
    public static final Map<DocumentType, SchemaValidationType> SCHEMA_MAP = Map.ofEntries(
            ...
            Map.entry(DocumentType.EARCHIVE_REPORT_EDOVIZ, SchemaValidationType.EARCHIVE_EDOVIZ),
            Map.entry(DocumentType.EARCHIVE_REPORT_EDEKONT, SchemaValidationType.EARCHIVE_EDEKONT),
            Map.entry(DocumentType.EARCHIVE_REPORT_EGIDER_PUSULASI, SchemaValidationType.EARCHIVE_EGIDER_PUSULASI),
    ...
    public static final Map<SchematronValidationType, String> SCHEMATRON_PATH_MAP = Map.ofEntries(
            ...
            Map.entry(SchematronValidationType.EARCHIVE_REPORT_EDOVIZ,
